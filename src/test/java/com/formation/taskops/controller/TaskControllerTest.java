...
class TaskControllerTest {
    ...
    // Pas d'ObjectMapper injecte : depuis Spring Boot 4 / Jackson 3,
    // com.fasterxml.jackson.databind n'existe plus (-> tools.jackson.databind,
    // JsonMapper). Un test de tranche web fixe le contrat HTTP : il ecrit son
    // JSON a la main, il ne doit pas reutiliser le serialiseur de l'application.
    ...
    /**
     * Module 4 : le constructeur de TaskController prend desormais un
     * CanaryService. @WebMvcTest ne charge QUE la couche web - aucun @Service
     * n'entre dans le contexte. Sans ce second mock, les cinq tests de cette
     * classe echouent tous sur "No qualifying bean of type CanaryService".
     */
    @MockitoBean
